...
- `0x4_` 打印设置 (可读取写入)
  ...
  - `0x43` 打印浓度 [见这里](#打印浓度)
  - `0x44` 打印速度 [见这里](#打印速度)
  - `0x45` 打印纸间隔 # TODO 那v1 v0 怎么办
    - `v2`机型: # TODO DP27P可以[这样](#打印纸间隔)
  - `0x46` (X)
  - `0x47` 电机模式
  - `0x48` 自动关机时间(分钟)
...
- `0x7_` 设备信息 (可读取)
  ...
  - `0x78` 时间同步 (可读取写入) # TODO 到底怎么用
    - 无参数调用: 查询某设备信息？
    - 调用: `1f 78 [TimeZone:2bBE] [Year:u16BE] [Month] [Day] [Week] [Hour] [Minute] [Second]` 设置时间。# TODO: 为什么要加100分钟?
      - `TimeZone`: 时区，未知 # TODO
