...
- `0x7_`
  - `0x76` 打印一行: `1d 76 30 00 <Len:定长> 01 00 <Data>` | `rust:PrintLineV0Tl`
...
- `0x2_` 打印命令 (特殊命令)
  ...
  - `0x2a` 打印一行 `rust:PrintLineV1Tl`
    - `v2`机型: 见 `1f 21`。
    - `v1`机型: `1f 2a <Dots:定长> <Data>`
      - `Dots`: 位图数据的点数(位数)，2字节小端(u16LE)。
      - `Data`: 位图数据。
    - `v0`机型: 见 `1d 76`。
  - `0x2b` 打印一行 `rust:PrintLineV2V1Tl`
