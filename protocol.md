...
## [变长编码](src/command/variable_bytes.rs)
...
- `0x2_` 打印命令 (特殊命令)
  - `0x20` 开始页命令
    - `v2`机型: `1f 20 <PAGE_KEY:定长> 00 00 00 00 <PRINT_SEPARATE_LINE> 00`
      - `PAGE_KEY`: 本页的编号，2字节小端(u16LE)。范围 `1~65534`，溢出重置到 `1`。
  ...
  - `0x29` 打印RLE*字节级*压缩的一行 TODO
    - `v2`机型: `1f 29 <RleByteLen:变长> <RleData>`。编码失败回退 `1f 21`。
      - `RleByteLen`: RLE数据字节数。
      - `RleData`: RLE数据。
  ...
  - `0x2b` 打印一行
    - `v2`机型: 见 `1f 21`。
    - `v1`机型: `1f 2b <Skips:变长> <DataLen:变长> <Data>`
      - `Skips`: 向右偏移的字节数。取值 `0~191`。
      - `DataLen`: 位图数据长度。取值 `0~191`。
      - `Data`: 位图数据。
    - `v0`机型: 见 `1d 76`。
  - `0x2c` 打印RLE*位级*压缩的一行 TODO
    - `v2`机型: `1f 2c <符号数:变长> <5位位流>`
    - `v1`机型: 没有这种命令。见 `1f 2b`。
    - `v0`机型: 没有这种命令。见 `1d 76`。
  - `0x2d` 打印RLE*位级*压缩的一行 TODO
    - `v2`机型: `1f 2c <符号数:变长> <5位位流>`
    - `v1`机型: 没有这种命令。见 `1f 2b`。
    - `v0`机型: 没有这种命令。见 `1d 76`。
  - `0x2e` 重复上一行
...
- `0x3_` 打印命令 (特殊命令)
  ...
  - `0x38` (X)
  - `0x39` (X)
  - `0x3a` 打印RLE*位级*压缩的一行 TODO
    - `v2`机型: `1f 2c <符号数:变长> <4位位流>`
    - `v1`机型: 没有这种命令。见 `1f 2b`。
    - `v0`机型: 没有这种命令。见 `1d 76`。
  - `0x3b` 打印RLE*位级*压缩的一行 TODO
    - `v2`机型: `1f 2c <符号数:变长> <4位位流>`
    - `v1`机型: 没有这种命令。见 `1f 2b`。
    - `v0`机型: 没有这种命令。见 `1d 76`。
  - `0x3c` 打印RLE*位级*压缩的一行 TODO
    - `v2`机型: `1f 2c <符号数:变长> <6位位流>`
    - `v1`机型: 没有这种命令。见 `1f 2b`。
    - `v0`机型: 没有这种命令。见 `1d 76`。
  - `0x3d` 打印RLE*位级*压缩的一行 TODO
    - `v2`机型: `1f 2c <符号数:变长> <6位位流>`
    - `v1`机型: 没有这种命令。见 `1f 2b`。
    - `v0`机型: 没有这种命令。见 `1d 76`。
  - `0x3e` (X)
